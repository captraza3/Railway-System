    ...
    <div class="bg"></div>
        ...
        <div class="form-group row">
            <div class="col-sm-4"></div>
                <select name="sduty" class="form-control col-sm-4" required>
...
<?php
    if (isset($_POST["sduty"])) {
	    $duty = $_POST["sduty"];
        $cnic = $_GET['cnic'];

        $qry = "update employee set duty_shift = '".$duty."' where emp_id = '".$cnic."'";
